...
const index = () => {
  ...
  const navigate = () => {
    route("/auth/signup/educator/select-language")
  }
  ...
  return (
    ...
    >
        ...
        <form action="" onSubmit={formik.handleSubmit}>
          ...
          <div>
            <p className="text-sm text-gray-500 py-3 text-right">
              ...
              <Link to={"/auth/signin/educator"} className="underline font-semibold">
                Login
              </Link>
            </p>
          </div>
      ...
      <div className="lg:block hidden">
        <img
          src="/images/auth/signup-img-6.png"
          alt="Picture"
          className="h-screen aspect-auto w-fit"
        />
        {/* For some reason next image optimization is causing the image not to load */}
      </div>
    </motion.main>
  )
}
