  ...
  return (
    ...
    >
      <div className="max-w-[500px] w-full px-3">
        ...
        {/* Heading */}
        <TypographyH4 className="pb-3">You are Almost there</TypographyH4>
        <p className="text-sm pb-6 text-gray-500">
          Select your preferred learning language so we can customize your
          experience
        </p>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <button
                ...
                onClick={handleClick}
              >
                Select {clicked ? <GoTriangleDown /> : <GoTriangleUp />}
              </button>
                ...
                <div className="flex flex-col gap-2">
                  {languageOptions.map(option => (
                    <div key={option.value} className="flex items-center">
                      <Checkbox
                        checked={formik.values.language.includes(option.value)}
                        onCheckedChange={isChecked => {
                          const selectedLanguages = [...formik.values.language]
                          if (isChecked) {
      ...
      <div className="lg:block hidden">
        <img
          src="/images/auth/signup-img-4.png"
          alt="logo"
        />
      </div>
    </motion.main>
